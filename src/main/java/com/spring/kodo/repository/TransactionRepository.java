...
public interface TransactionRepository extends JpaRepository<Transaction, Long>
{
    ...
    List<Transaction> getMonthlyTransactionByCourseId(@Param("courseId") Long courseId, @Param("inputYear") Year inputYear, @Param("inputMonth") Month inputMonth);
    ...
    List<Transaction> getMonthlyTransactionByPayeeId(@Param("payeeId") Long payeeId, @Param("inputYear") Year inputYear, @Param("inputMonth") Month inputMonth);
    ...
    List<CourseWithEarningResp> getAllTransactionsByGroupbyCourseByMonth(@Param("inputYear") Year inputYear, @Param("inputMonth") Month inputMonth);
